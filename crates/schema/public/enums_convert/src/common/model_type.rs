use enums_api::common::model_type::ModelType as Api;
use enums_db::common::model_type::ModelType as Db;
...
pub fn model_type_to_db(api_value: &Api) -> Db {
  match api_value {
    ...
    Api::MidjourneyV6 => Db::MidjourneyV6,
    Api::MidjourneyV6p1 => Db::MidjourneyV6p1,
    Api::MidjourneyV6p1Raw => Db::MidjourneyV6p1Raw,
    Api::MidjourneyV7 => Db::MidjourneyV7,
    Api::MidjourneyV7Draft => Db::MidjourneyV7Draft,
    Api::MidjourneyV7DraftRaw => Db::MidjourneyV7DraftRaw,
    Api::MidjourneyV7Raw => Db::MidjourneyV7Raw,
    ...
    Api::Seedance10Pro => Db::Seedance10Pro,
    ...
    Api::Marble0p1Mini => Db::Marble0p1Mini,
    Api::Marble0p1Plus => Db::Marble0p1Plus,
  }
}
...
pub fn model_type_to_api(db_value: &Db) -> Api {
  match db_value {
    ...
    Db::MidjourneyV6 => Api::MidjourneyV6,
    Db::MidjourneyV6p1 => Api::MidjourneyV6p1,
    Db::MidjourneyV6p1Raw => Api::MidjourneyV6p1Raw,
    Db::MidjourneyV7 => Api::MidjourneyV7,
    Db::MidjourneyV7Draft => Api::MidjourneyV7Draft,
    Db::MidjourneyV7DraftRaw => Api::MidjourneyV7DraftRaw,
    Db::MidjourneyV7Raw => Api::MidjourneyV7Raw,
    ...
    Db::Seedance10Pro => Api::Seedance10Pro,
    ...
    Db::Marble0p1Mini => Api::Marble0p1Mini,
    Db::Marble0p1Plus => Api::Marble0p1Plus,
  }
}
...
mod tests {
  ...
  fn round_trip_api_to_db() {
    ...
    for variant in Api::iter() {
      let db = model_type_to_db(&variant);
