...
impl MediaFileOriginCategory {
  pub fn to_str(&self) -> &'static str {
    match self {
      ...
      Self::ThirdPartyInference => "3p_inference",
    }
  }
  ...
  pub fn from_str(value: &str) -> Result<Self, String> {
    match value {
      ...
      "3p_inference" => Ok(Self::ThirdPartyInference),
...
mod tests {
  ...
  mod explicit_checks {
    ...
    fn test_serialization() {
      ...
      assert_serialization(MediaFileOriginCategory::ThirdPartyInference, "3p_inference");
    }
    ...
    fn test_to_str() {
      ...
      assert_eq!(MediaFileOriginCategory::ThirdPartyInference.to_str(), "3p_inference");
    }
    ...
    fn test_from_str() {
      ...
      assert_eq!(MediaFileOriginCategory::from_str("3p_inference").unwrap(), MediaFileOriginCategory::ThirdPartyInference);
