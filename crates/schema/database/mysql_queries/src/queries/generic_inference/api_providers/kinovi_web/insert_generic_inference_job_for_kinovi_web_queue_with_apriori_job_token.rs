...
pub struct InsertGenericInferenceForKinoviWebWithAprioriJobTokenArgs<'e, 'c, E>
  where E: 'e + Executor<'c, Database = MySql>
{
  ...
  /// The external order_id returned by the kinovi_web generate_video call.
...
pub async fn insert_generic_inference_job_for_kinovi_web_queue_with_apriori_job_token<'e, 'c : 'e, E>(
  args: InsertGenericInferenceForKinoviWebWithAprioriJobTokenArgs<'e, 'c, E>
