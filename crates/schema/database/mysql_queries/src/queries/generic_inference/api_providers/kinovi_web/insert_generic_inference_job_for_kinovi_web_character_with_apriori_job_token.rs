...
pub struct InsertGenericInferenceForKinoviWebCharacterWithAprioriJobTokenArgs<'e, 'c, E>
...
pub async fn insert_generic_inference_job_for_kinovi_web_character_with_apriori_job_token<'e, 'c : 'e, E>(
  args: InsertGenericInferenceForKinoviWebCharacterWithAprioriJobTokenArgs<'e, 'c, E>
  ...
  where E: 'e + Executor<'c, Database = MySql>
{
  ...
  info!("Insert generic inference job for KinoviWeb character: {} with record ID {}", args.apriori_job_token, record_id);
