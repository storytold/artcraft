...
/// the media class (to decide whether the file can be used as a cover
/// directly), and the file's own self-referential cover-image token (for
/// the "use the cover's cover" fallback). Excludes soft-deleted rows.
