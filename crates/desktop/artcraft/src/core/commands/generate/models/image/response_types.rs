...
impl From<ApiClientImageModel> for ListImageModelsImageModel {
  fn from(value: ApiClientImageModel) -> Self {
    match value {
      ...
      ApiClientImageModel::GptImage2p5Flare => Self::GptImage2p5Flare,
      ApiClientImageModel::GptImage2p5Sunburst => Self::GptImage2p5Sunburst,
...
impl From<ListImageModelsImageModel> for String {
  fn from(value: ListImageModelsImageModel) -> Self {
    match value {
      ...
      ListImageModelsImageModel::GptImage2p5Flare => "gpt_image_2p5_flare".to_string(),
      ListImageModelsImageModel::GptImage2p5Sunburst => "gpt_image_2p5_sunburst".to_string(),
