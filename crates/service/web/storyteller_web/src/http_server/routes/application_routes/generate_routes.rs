  ...
  app.service(web::scope("/v1/generate")
      ...
      .service(web::scope("/video")
          .service(web::scope("/multi_function")
              ...
              .service(web::resource("/kling_3p0_standard")
                  .route(web::post().to(kling_3p0_standard_multi_function_video_gen_handler))
                  .route(web::head().to(|| HttpResponse::Ok()))
              )
              .service(web::resource("/kling_3p0_pro")
                  .route(web::post().to(kling_3p0_pro_multi_function_video_gen_handler))
                  .route(web::head().to(|| HttpResponse::Ok()))
              )
