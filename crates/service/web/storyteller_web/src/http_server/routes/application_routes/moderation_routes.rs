...
use crate::http_server::endpoints::moderation::user_jobs::list_user_jobs_handler::list_user_jobs_handler;
      ...
      >,
{
  app.service(web::scope("/v1/moderation")
        ...
        .service(web::scope("/user_jobs")
            .service(web::resource("/{user_token}/list")
