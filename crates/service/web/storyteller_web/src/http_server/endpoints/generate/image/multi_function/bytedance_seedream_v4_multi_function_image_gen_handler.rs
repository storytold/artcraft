...
pub async fn bytedance_seedream_v4_multi_function_image_gen_handler(
...
) -> Result<Json<BytedanceSeedreamV4MultiFunctionImageGenResponse>, AdvancedCommonWebError> {
  ...
  if let Some(input_image_urls) = image_urls.as_deref() {
    ...
    let edit_request = EnqueueBytedanceSeedreamV4EditImageRequest {
  ...
  let prompt_result = insert_prompt(InsertPromptArgs {
    ...
    maybe_model_type: Some(CommonModelType::Seedream4),
