...
pub async fn enqueue_infer_seed_vc_handler(
  ...
  let query_result = insert_generic_inference_job(InsertGenericInferenceArgs {
    ...
    maybe_input_source_token_type: Some(enums_convert::by_table::generic_inference_jobs::inference_input_source_token_type::inference_input_source_token_type_to_api(&source_media_token_type)),
