...
fn convert_model(
  model: &enums::common::generation::common_video_model::CommonVideoModel,
) -> Result<artcraft_router::api::common_video_model::CommonVideoModel, AdvancedCommonWebError> {
