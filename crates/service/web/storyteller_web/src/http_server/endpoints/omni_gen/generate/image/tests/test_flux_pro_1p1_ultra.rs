...
mod tests {
  ...
  mod plan {
    ...
    fn with_fal_plan<F: FnOnce(&PlanFalFluxPro11Ultra)>(
    ...
    fn assert_plan_for_aspect_ratio<F: FnOnce(&PlanFalFluxPro11Ultra)>(
    ...
    fn assert_plan_for_batch<F: FnOnce(&PlanFalFluxPro11Ultra)>(
      batch: Option<u16>,
      assertion: F,
    ) {
