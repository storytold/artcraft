...
pub async fn enqueue_studio_workflow_handler(
  ...
  let query_result = insert_generic_inference_job(InsertGenericInferenceArgs {
    ...
    maybe_product_category: Some(enums_convert::by_table::generic_inference_jobs::inference_job_product_category::inference_job_product_category_to_api(&InferenceJobProductCategory::VidStudio)),
