...
pub fn seedance_2p5_video_models() -> Vec<OmniGenVideoModelDetails> {
  ...
  models.push(OmniGenVideoModelDetails {
    ...
    extra_info: Some("A preview of Seedance 2.5. Supports videos up to 30 seconds and up to 12 reference images, but only reference mode (no start/end keyframes) and 480p/720p output.".to_string()),
