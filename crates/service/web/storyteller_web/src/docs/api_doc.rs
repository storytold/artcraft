...
use enums_api::by_table::comments::comment_entity_type::CommentEntityType;
use enums_api::by_table::featured_items::featured_item_entity_type::FeaturedItemEntityType;
...
use enums_api::by_table::media_files::media_file_animation_type::MediaFileAnimationType;
use enums_api::by_table::media_files::media_file_class::MediaFileClass;
use enums_api::by_table::media_files::media_file_engine_category::MediaFileEngineCategory;
...
use enums_api::by_table::media_files::media_file_subtype::MediaFileSubtype;
use enums_api::by_table::media_files::media_file_type::MediaFileType;
use enums_api::by_table::model_weights::{weights_category::WeightsCategory, weights_types::WeightsType};
use enums_api::by_table::prompt_context_items::prompt_context_semantic_type::PromptContextSemanticType;
...
use enums_api::by_table::user_ratings::entity_type::UserRatingEntityType;
use enums_api::by_table::user_ratings::rating_value::UserRatingValue;
...
#[openapi(
  ...
  components(schemas(
    ...
    FrontendFailureCategoryForOldClients,
    GenerationProvider,
    InferenceCategory,
    JobStatusPlus,
