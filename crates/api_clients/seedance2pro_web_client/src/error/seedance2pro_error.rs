...
pub enum Seedance2ProError {
  Client(Seedance2ProWebClientError),
...
impl std::fmt::Display for Seedance2ProError {
  fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    match self {
      Self::Client(e) => write!(f, "Seedance2ProWebClientError: {:?}", e),
...
impl From<Seedance2ProWebClientError> for Seedance2ProError {
  fn from(error: Seedance2ProWebClientError) -> Self {
    Self::Client(error)
  }
}
