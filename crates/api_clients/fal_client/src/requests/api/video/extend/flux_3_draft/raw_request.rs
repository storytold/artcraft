...
/// Over-the-wire input shape for `blackforestlabs/flux-3/extend-video/draft`.
/// fal's schema: <https://fal.ai/models/blackforestlabs/flux-3/extend-video/draft/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Flux3DraftExtendVideoInput {
...
pub struct Flux3DraftExtendVideoVideoFile {
  pub url: String,
}
...
/// 1080p render.
#[derive(Debug, Serialize, Deserialize)]
pub struct Flux3DraftExtendVideoOutput {
  pub video: Flux3DraftExtendVideoVideoFile,
  pub draft_cache: Flux3DraftExtendVideoVideoFile,
}
