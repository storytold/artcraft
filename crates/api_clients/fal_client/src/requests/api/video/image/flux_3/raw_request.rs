...
/// Over-the-wire input shape for `blackforestlabs/flux-3/image-to-video`.
/// fal's schema: <https://fal.ai/models/blackforestlabs/flux-3/image-to-video/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Flux3ImageToVideoInput {
...
pub struct Flux3ImageToVideoVideoFile {
  pub url: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct Flux3ImageToVideoOutput {
  pub video: Flux3ImageToVideoVideoFile,
}
