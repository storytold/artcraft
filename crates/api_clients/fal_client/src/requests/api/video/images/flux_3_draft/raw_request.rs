...
/// Over-the-wire input shape for `blackforestlabs/flux-3/first-last-frame-to-video/draft`.
/// fal's schema: <https://fal.ai/models/blackforestlabs/flux-3/first-last-frame-to-video/draft/api>
#[derive(Debug, Serialize, Deserialize, Default)]
pub struct Flux3DraftFirstLastFrameToVideoInput {
...
pub struct Flux3DraftFirstLastFrameToVideoVideoFile {
  pub url: String,
}
...
/// 1080p render.
#[derive(Debug, Serialize, Deserialize)]
pub struct Flux3DraftFirstLastFrameToVideoOutput {
  pub video: Flux3DraftFirstLastFrameToVideoVideoFile,
  pub draft_cache: Flux3DraftFirstLastFrameToVideoVideoFile,
}
