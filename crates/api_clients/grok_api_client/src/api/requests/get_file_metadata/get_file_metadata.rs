...
use crate::api::requests::get_file_metadata::request_types::*;
...
pub async fn get_file_metadata(args: GetFileMetadataArgs) -> Result<FileMetadata, GrokError> {
  let url = format!("{}/v1/files/{}", XAI_API_BASE_URL, args.file_id);

  info!("Grok get_file_metadata: file_id={}", args.file_id);
