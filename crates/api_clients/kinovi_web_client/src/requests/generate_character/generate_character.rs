...
pub async fn generate_character(args: GenerateCharacterArgs<'_>) -> Result<GenerateCharacterResponse, KinoviWebError> {
...
mod tests {
  ...
  async fn upload_image_from_url(session: &KinoviWebSession, image_url: &str, extension: &str) -> AnyhowResult<String> {
