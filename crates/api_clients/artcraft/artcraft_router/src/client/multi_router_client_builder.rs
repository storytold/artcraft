...
pub struct MultiRouterClientBuilder {
  ...
  seedance2pro_web_client: Option<RouterSeedance2ProWebClient>,
...
impl MultiRouterClientBuilder {
  ...
  pub fn set_seedance2pro_client(mut self, client: RouterSeedance2ProWebClient) -> Self {
    self.seedance2pro_web_client = Some(client);
    self
  }
  ...
  pub fn build(self) -> MultiRouterClient {
    MultiRouterClient {
      ...
      seedance2pro_web_client: self.seedance2pro_web_client,
