...
impl GenerateVideoRequestBuilder {
  ...
  pub fn build2(self) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
    match (self.provider, self.model) {
      // Artcraft
      (Provider::Artcraft, RouterVideoModel::GrokImagineVideo) => build_artcraft_grok_imagine_video(self),
      (Provider::Artcraft, RouterVideoModel::HappyHorse1p0) => build_artcraft_happy_horse_1p0(self),
      (Provider::Artcraft, RouterVideoModel::Kling16Pro) => build_artcraft_kling_1_6_pro(self),
      (Provider::Artcraft, RouterVideoModel::Kling21Master) => build_artcraft_kling_2_1_master(self),
      (Provider::Artcraft, RouterVideoModel::Kling21Pro) => build_artcraft_kling_2_1_pro(self),
      (Provider::Artcraft, RouterVideoModel::Kling2p5TurboPro) => build_artcraft_kling_2_5_turbo_pro(self),
      (Provider::Artcraft, RouterVideoModel::Kling2p6Pro) => build_artcraft_kling_2_6_pro(self),
      (Provider::Artcraft, RouterVideoModel::Kling3p0Pro) => build_artcraft_kling_3p0_pro(self),
      (Provider::Artcraft, RouterVideoModel::Kling3p0Standard) => build_artcraft_kling_3p0_standard(self),
      (Provider::Artcraft, RouterVideoModel::Seedance2p0) => build_artcraft_seedance_2p0(self),
      (Provider::Artcraft, RouterVideoModel::Seedance2p0Fast) => build_artcraft_seedance_2p0_fast(self),
      (Provider::Artcraft, RouterVideoModel::Seedance2p0Ultra) => build_artcraft_seedance_2p0_u(self),
      (Provider::Artcraft, RouterVideoModel::Seedance2p0UltraFast) => build_artcraft_seedance_2p0_u_fast(self),
      (Provider::Artcraft, RouterVideoModel::Seedance2p0BytePlus) => build_artcraft_seedance_2p0_bp(self),
      (Provider::Artcraft, RouterVideoModel::Seedance2p0BytePlusFast) => build_artcraft_seedance_2p0_bp_fast(self),
      (Provider::Artcraft, RouterVideoModel::PreviewModel) => build_artcraft_preview_model(self),
      (Provider::Artcraft, RouterVideoModel::PreviewModelFast) => build_artcraft_preview_model_fast(self),
      (Provider::Artcraft, RouterVideoModel::Seedance10Lite) => build_artcraft_seedance_1p0_lite(self),
      (Provider::Artcraft, RouterVideoModel::Seedance1p5Pro) => build_artcraft_seedance_1p5_pro(self),
      (Provider::Artcraft, RouterVideoModel::Sora2) => build_artcraft_sora_2(self),
      (Provider::Artcraft, RouterVideoModel::Sora2Pro) => build_artcraft_sora_2_pro(self),
      (Provider::Artcraft, RouterVideoModel::Veo2) => build_artcraft_veo_2(self),
      (Provider::Artcraft, RouterVideoModel::Veo3) => build_artcraft_veo_3(self),
      (Provider::Artcraft, RouterVideoModel::Veo3Fast) => build_artcraft_veo_3_fast(self),
      (Provider::Artcraft, RouterVideoModel::Veo3p1) => build_artcraft_veo_3p1(self),
      (Provider::Artcraft, RouterVideoModel::Veo3p1Fast) => build_artcraft_veo_3p1_fast(self),
      // Fal
      (Provider::Fal, RouterVideoModel::Kling16Pro) => build_fal_kling_1_6_pro(self),
      (Provider::Fal, RouterVideoModel::Kling21Master) => build_fal_kling_2_1_master(self),
      (Provider::Fal, RouterVideoModel::Kling21Pro) => build_fal_kling_2_1_pro(self),
      (Provider::Fal, RouterVideoModel::Kling2p5TurboPro) => build_fal_kling_2_5_turbo_pro(self),
      (Provider::Fal, RouterVideoModel::Kling2p6Pro) => build_fal_kling_2_6_pro(self),
      (Provider::Fal, RouterVideoModel::Kling3p0Pro) => build_fal_kling_3p0_pro(self),
      (Provider::Fal, RouterVideoModel::Kling3p0Standard) => build_fal_kling_3p0_standard(self),
      (Provider::Fal, RouterVideoModel::Seedance10Lite) => build_fal_seedance_1p0_lite(self),
      (Provider::Fal, RouterVideoModel::Seedance1p5Pro) => build_fal_seedance_1p5_pro(self),
      (Provider::Fal, RouterVideoModel::Sora2) => build_fal_sora_2(self),
      (Provider::Fal, RouterVideoModel::Sora2Pro) => build_fal_sora_2_pro(self),
      (Provider::Fal, RouterVideoModel::Veo2) => build_fal_veo_2(self),
      (Provider::Fal, RouterVideoModel::Veo3) => build_fal_veo_3(self),
      (Provider::Fal, RouterVideoModel::Veo3Fast) => build_fal_veo_3_fast(self),
      (Provider::Fal, RouterVideoModel::Veo3p1) => build_fal_veo_3p1(self),
      (Provider::Fal, RouterVideoModel::Veo3p1Fast) => build_fal_veo_3p1_fast(self),
      // GmiCloud
      (Provider::GmiCloud, RouterVideoModel::Seedance2p0Ultra) => build_gmicloud_seedance_2p0_u(self),
      (Provider::GmiCloud, RouterVideoModel::Seedance2p0UltraFast) => build_gmicloud_seedance_2p0_u_fast(self),
      // Grok
      (Provider::GrokApi, RouterVideoModel::GrokImagineVideo) => build_grok_api_grok_imagine_video(self),
      // Kinovi
      (Provider::Seedance2Pro, RouterVideoModel::HappyHorse1p0) => build_kinovi_happy_horse_1p0(self),
      (Provider::Seedance2Pro, RouterVideoModel::Seedance2p0) => build_kinovi_seedance_2p0(self),
      (Provider::Seedance2Pro, RouterVideoModel::Seedance2p0Fast) => build_kinovi_seedance_2p0_fast(self),
