...
/// 500,000-credit package (231 credits/$1) Kinovi costs only 6/11/21¢ —
...
mod tests {
  ...
  //
  // Kinovi midjourney_7 costs 6/11/21¢ for batches 1/2/4 under the
  // 500,000-credit package. The artcraft user price (6/12/25¢) must always
