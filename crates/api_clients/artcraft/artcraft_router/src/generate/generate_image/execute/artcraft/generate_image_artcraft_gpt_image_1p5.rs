...
use artcraft_api_defs::generate::image::multi_function::gpt_image_1p5_multi_function_image_gen::GptImage1p5MultiFunctionImageGenRequest;
...
pub async fn execute_artcraft_gpt_image_1p5(
  ...
  let response = gpt_image_1p5_multi_function_image_gen(
...
mod tests {
  ...
  #[tokio::test]
  #[ignore] // manually run — fires a real API request and incurs cost
  async fn test_edit_image_gpt_image_1p5() {
    let client = get_artcraft_client();
  ...
  async fn test_text_to_image_gpt_image_1p5_all_aspect_ratios() {
    let client = get_artcraft_client();
  ...
  #[tokio::test]
  #[ignore] // manually run — fires one real API request per aspect ratio variant (expensive)
  async fn test_edit_image_gpt_image_1p5_all_aspect_ratios() {
    let client = get_artcraft_client();
