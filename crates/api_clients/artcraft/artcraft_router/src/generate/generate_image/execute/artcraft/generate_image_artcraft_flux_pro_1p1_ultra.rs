...
pub async fn execute_artcraft_flux_pro_1p1_ultra(
  ...
  let response = generate_flux_pro_11_ultra_text_to_image(
...
mod tests {
  ...
  use crate::test_helpers::{base_flux_pro_1p1_ultra_image_request, get_artcraft_client};
  use strum::IntoEnumIterator;

  #[tokio::test]
  #[ignore] // manually run — fires a real API request and incurs cost
  async fn test_text_to_image_flux_pro_1p1_ultra() {
  ...
  #[tokio::test]
  #[ignore] // manually run — fires a real API request and incurs cost
  async fn test_text_to_image_flux_pro_1p1_ultra_batch_four() {
    let client = get_artcraft_client();
    let request = GenerateImageRequest {
  ...
  async fn test_text_to_image_flux_pro_1p1_ultra_all_aspect_ratios() {
    let client = get_artcraft_client();
