...
use artcraft_api_defs::generate::image::angle::qwen_edit_2511_edit_image_angle::QwenEdit2511EditImageAngleRequest;
...
pub async fn execute_artcraft_qwen_edit_2511_angles(
  ...
  let response = qwen_edit_2511_edit_image_angle(
...
mod tests {
  ...
  use crate::test_helpers::{base_qwen_edit_2511_angles_image_request, get_artcraft_client};
  use tokens::tokens::media_files::MediaFileToken;

  #[tokio::test]
  #[ignore] // manually run — fires a real API request and incurs cost
  async fn test_angle_edit_qwen_edit_2511() {
