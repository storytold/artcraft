...
pub(crate) fn estimate_image_cost_fal_nano_banana_pro(
  ...
  let cost_per_image: u64 = match plan.resolution {
    Some(FalNbpResolution::FourK) => 30,
    _ => 15,
  };

  let num_images: u64 = match plan.num_images {
    FalNbpNumImages::One => 1,
    FalNbpNumImages::Two => 2,
    FalNbpNumImages::Three => 3,
    FalNbpNumImages::Four => 4,
  };
