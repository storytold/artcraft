...
pub struct PlanArtcraftQwenEdit2511Angles<'a> {
  ...
  pub num_images: QwenEdit2511EditImageAngleNumImages,
...
// Qwen Edit 2511 supported image sizes:
//   Square, SquareHd
...
) -> Result<Option<QwenEdit2511EditImageAngleImageSize>, ArtcraftRouterError> {
  use QwenEdit2511EditImageAngleImageSize as S;
  match aspect_ratio {
    None => Ok(None),
...
fn plan_num_images(
  ...
  strategy: RequestMismatchMitigationStrategy,
) -> Result<QwenEdit2511EditImageAngleNumImages, ArtcraftRouterError> {
  use QwenEdit2511EditImageAngleNumImages as N;
...
mod tests {
  ...
  use artcraft_api_defs::generate::image::angle::qwen_edit_2511_edit_image_angle::{
    ...
    QwenEdit2511EditImageAngleNumImages as N,
  };
  use tokens::tokens::media_files::MediaFileToken;
