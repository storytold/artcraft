...
#[derive(Debug, Clone)]
pub struct PlanArtcraftSeedream4p5<'a> {
...
pub fn plan_generate_image_artcraft_seedream_4p5<'a>(
  request: &'a GenerateImageRequest<'a>,
) -> Result<PlanArtcraftSeedream4p5<'a>, ArtcraftRouterError> {
