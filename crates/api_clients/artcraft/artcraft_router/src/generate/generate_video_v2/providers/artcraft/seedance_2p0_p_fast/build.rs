...
pub fn build_artcraft_seedance_2p0_p_fast(mut builder: GenerateVideoRequestBuilder) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
  ...
  let request = OmniGenVideoCostAndGenerateRequest {
    model: Some(CommonVideoModelEnum::Seedance2p0PlusFast),
...
// Supports output resolutions: 480p and 720p only.
