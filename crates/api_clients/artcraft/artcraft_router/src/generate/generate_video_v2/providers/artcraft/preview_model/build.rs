...
pub fn build_artcraft_preview_model(mut builder: GenerateVideoRequestBuilder) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
  ...
  let request = OmniGenVideoCostAndGenerateRequest {
    model: Some(CommonVideoModelEnum::PreviewModel),
...
// PreviewModel supports output resolutions: 480p, 720p, 1080p.
