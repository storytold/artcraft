...
pub fn build_artcraft_seedance_2p0_fast_g(mut builder: GenerateVideoRequestBuilder) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
  ...
  let request = OmniGenVideoCostAndGenerateRequest {
    model: Some(CommonVideoModelEnum::Seedance2p0FastGlobal),
