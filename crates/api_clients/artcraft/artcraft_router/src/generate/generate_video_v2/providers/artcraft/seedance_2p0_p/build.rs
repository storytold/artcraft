...
pub fn build_artcraft_seedance_2p0_p(mut builder: GenerateVideoRequestBuilder) -> Result<VideoGenerationDraftOrRequest, ArtcraftRouterError> {
  ...
  let request = OmniGenVideoCostAndGenerateRequest {
    model: Some(CommonVideoModelEnum::Seedance2p0Plus),
...
// Supports output resolutions: 480p, 720p, 1080p.
