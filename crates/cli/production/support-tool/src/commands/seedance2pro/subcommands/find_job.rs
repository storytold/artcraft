...
use seedance2pro_web_client::requests::poll_orders::poll_orders::{poll_orders, PollOrdersArgs};
...
fn order_to_json(order: &seedance2pro_web_client::requests::poll_orders::poll_orders::OrderStatus) -> serde_json::Value {
  serde_json::json!({
