...
export enum CommonImageModel {
  ...
  GrokImagineImage = "grok_imagine_image",
  GrokImagineImageQuality = "grok_imagine_image_q",
  Midjourney7 = "midjourney_7",
  Midjourney7Niji = "midjourney_7_niji",
  Midjourney8 = "midjourney_8",
  ...
  Seedream5p0Pro = "seedream_5p0_pro",
  Seedream5p0ProUltra = "seedream_5p0_pro_u",
