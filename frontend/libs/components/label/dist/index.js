import { jsxs as oe, jsx as ne } from "react/jsx-runtime";
const B = "-", se = (e) => {
  const r = ie(e), {
  ...
  return {
    getClassGroupId: (i) => {
      const s = i.split(B);
      return s[0] === "" && s.length !== 1 && s.shift(), Y(s, r) || le(i);
    },
  ...
  const {
    ...
    const y = u.length === 0 ? s : s.substring(m), v = y.startsWith(D), w = v ? y.substring(1) : y, b = x && x > m ? x - m : void 0;
    return {
      modifiers: u,
  ...
  for (let u = i.length - 1; u >= 0; u -= 1) {
    ...
    const p = ue(m).join(":"), f = x ? p + D : p, h = f + b;
    if (n.includes(h))
      continue;
    n.push(h);
    const R = a(b, w);
...
const c = (e) => {
...
}, re = /^\[(?:([a-z-]+):)?(.+)\]$/i, xe = /^\d+\/\d+$/, ye = /* @__PURE__ */ new Set(["px", "full", "screen"]), we = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, ve = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ke = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, Ce = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, ze = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, C = (e) => M(e) || ye.has(e) || xe.test(e), z = (e) => G(e, "length", je), M = (e) => !!e && !Number.isNaN(Number(e)), _ = (e) => G(e, "number", M), P = (e) => !!e && Number.isInteger(Number(e)), Se = (e) => e.endsWith("%") && M(e.slice(0, -1)), l = (e) => re.test(e), S = (e) => we.test(e), Ae = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Me = (e) => G(e, Ae, te), Ge = (e) => G(e, "position", te), Re = /* @__PURE__ */ new Set(["image", "url"]), Ie = (e) => G(e, Re, Ee), Pe = (e) => G(e, "", Ne), j = () => !0, G = (e, r, t) => {
  const o = re.exec(e);
  ...
  ve.test(e) && !ke.test(e)
), te = () => !1, Ne = (e) => Ce.test(e), Ee = (e) => ze.test(e), Te = () => {
  ...
  "label",
  {
    className: Le("text-base-fg mb-2 text-[15px] font-medium", e),
    ...o,
    children: [
      r,
      t && /* @__PURE__ */ ne("span", { className: "ml-0.5 text-[#ff6467]", children: "*" })
    ]
  }
);
export {
