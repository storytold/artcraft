...
const B = "-", se = (e) => {
  ...
  return {
    getClassGroupId: (i) => {
      const s = i.split(B);
      return s[0] === "" && s.length !== 1 && s.shift(), D(s, r) || le(i);
    },
  ...
  return ce(Object.entries(e.classGroups), t).forEach(([n, i]) => {
    $(i, o, n, r);
  }), o;
}, $ = (e, r, t, o) => {
  e.forEach((a) => {
  ...
  const {
    ...
    const y = u.length === 0 ? s : s.substring(m), v = y.startsWith(ee), w = v ? y.substring(1) : y, b = x && x > m ? x - m : void 0;
    return {
      modifiers: u,
  ...
  for (let u = i.length - 1; u >= 0; u -= 1) {
    ...
    let w = !!v, b = o(w ? y.substring(0, v) : y);
    if (!b) {
      if (!w) {
        s = g + (s.length > 0 ? " " + s : s);
        continue;
    ...
    const p = ue(m).join(":"), f = x ? p + ee : p, h = f + b;
    if (n.includes(h))
      continue;
    n.push(h);
    const R = a(b, w);
...
function he(e, ...r) {
  let t, o, a, n = i;
  function i(u) {
    const g = r.reduce((m, x) => x(m), e());
    return t = be(g), o = t.cache.get, a = t.cache.set, n = s, s(u);
  }
  function s(u) {
    const g = o(u);
    if (g)
...
const c = (e) => {
...
}, te = /^\[(?:([a-z-]+):)?(.+)\]$/i, xe = /^\d+\/\d+$/, ye = /* @__PURE__ */ new Set(["px", "full", "screen"]), we = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, ve = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ke = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, Ce = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, ze = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, C = (e) => M(e) || ye.has(e) || xe.test(e), z = (e) => G(e, "length", je), M = (e) => !!e && !Number.isNaN(Number(e)), _ = (e) => G(e, "number", M), P = (e) => !!e && Number.isInteger(Number(e)), Se = (e) => e.endsWith("%") && M(e.slice(0, -1)), l = (e) => te.test(e), S = (e) => we.test(e), Ae = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Me = (e) => G(e, Ae, oe), Ge = (e) => G(e, "position", oe), Re = /* @__PURE__ */ new Set(["image", "url"]), Ie = (e) => G(e, Re, Ee), Pe = (e) => G(e, "", Ne), j = () => !0, G = (e, r, t) => {
  const o = te.exec(e);
  ...
  const e = c("colors"), r = c("spacing"), t = c("blur"), o = c("brightness"), a = c("borderColor"), n = c("borderRadius"), i = c("borderSpacing"), s = c("borderWidth"), u = c("contrast"), g = c("grayscale"), m = c("hueRotate"), x = c("invert"), y = c("gap"), v = c("gradientColorStops"), w = c("gradientColorStopPositions"), b = c("inset"), p = c("margin"), f = c("opacity"), h = c("padding"), R = c("saturate"), A = c("scale"), N = c("sepia"), U = c("skew"), F = c("space"), q = c("translate"), L = () => ["auto", "contain", "none"], W = () => ["auto", "hidden", "clip", "visible", "scroll"], V = () => ["auto", l, r], d = () => [l, r], H = () => ["", C, z], E = () => ["auto", M, l], J = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], T = () => ["solid", "dashed", "dotted", "double", "none"], X = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], O = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], I = () => ["", "0", l], Z = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], k = () => [M, l];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
...
}, Le = /* @__PURE__ */ he(Te), Ve = ({
  className: e,
  thickness: r = 4
}) => /* @__PURE__ */ ne(
  "svg",
  {
    className: Le("h-6 w-6 animate-spin", e),
