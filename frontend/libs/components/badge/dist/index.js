...
const B = "-", ne = (e) => {
  ...
  for (let u = i.length - 1; u >= 0; u -= 1) {
    ...
    const p = pe(m).join(":"), f = x ? p + D : p, h = f + b;
    if (n.includes(h))
      continue;
    n.push(h);
    const R = a(b, w);
...
const c = (e) => {
...
}, re = /^\[(?:([a-z-]+):)?(.+)\]$/i, he = /^\d+\/\d+$/, xe = /* @__PURE__ */ new Set(["px", "full", "screen"]), ye = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, we = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ve = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, ke = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Ce = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, C = (e) => M(e) || xe.has(e) || he.test(e), z = (e) => G(e, "length", Pe), M = (e) => !!e && !Number.isNaN(Number(e)), _ = (e) => G(e, "number", M), P = (e) => !!e && Number.isInteger(Number(e)), ze = (e) => e.endsWith("%") && M(e.slice(0, -1)), l = (e) => re.test(e), S = (e) => ye.test(e), Se = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Ae = (e) => G(e, Se, te), Me = (e) => G(e, "position", te), Ge = /* @__PURE__ */ new Set(["image", "url"]), Re = (e) => G(e, Ge, Ee), Ie = (e) => G(e, "", je), j = () => !0, G = (e, r, t) => {
  const o = re.exec(e);
  ...
  we.test(e) && !ve.test(e)
), te = () => !1, je = (e) => ke.test(e), Ee = (e) => Ce.test(e), Ne = () => {
...
}, Te = /* @__PURE__ */ me(Ne), We = ({ label: e, className: r }) => /* @__PURE__ */ oe(
  "div",
  {
    className: Te(
