...
export const IMAGE_MODELS: ImageModel[] = [
  ...
  new ImageModel({
    id: "gpt_image_2p5_flare",
    tauriId: "gpt_image_2p5_flare",
    fullName: "GPT Image 2.5 Flare",
    category: "image",
    creator: ModelCreator.OpenAi,
    selectorName: "GPT Image 2.5 Flare",
    selectorDescription: "Precise edits, keeps subjects intact",
    selectorBadges: ["60 sec."],
    maxGenerationCount: 4,
    defaultGenerationCount: 1,
    tags: [ModelTag.InstructiveEdit],
    ...
    defaultResolution: CommonResolution.OneK,
    defaultQuality: CommonQuality.High,
    qualityOptions: [
      CommonQuality.Auto,
      CommonQuality.Max,
  ...
  new ImageModel({
    id: "gpt_image_2p5_sunburst",
    tauriId: "gpt_image_2p5_sunburst",
    fullName: "GPT Image 2.5 Sunburst",
    category: "image",
    creator: ModelCreator.OpenAi,
    selectorName: "GPT Image 2.5 Sunburst",
    selectorDescription: "Premium detail, slower",
    selectorBadges: ["2 min."],
    maxGenerationCount: 4,
    defaultGenerationCount: 1,
    tags: [ModelTag.InstructiveEdit],
