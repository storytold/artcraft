...
export const galaxyMotionTuner = defineTunables(
  ...
  "Galaxy motion",
  {
    ...
    introStagger: {
      ...
      step: 0.01,
      default: 0.08,
      info: "Delay between successive cards launching from the center during the intro rollout (scattered order). The rollout starts at the master Intro group's Cards beat.",
    },
    introDur: {
      label: "Roll dur s",
      min: 0.2,
      ...
      step: 0.05,
      default: 0.6,
      info: "Duration of each card's roll from the center out to its conveyor position along its arm.",
    },
    perfFloor: {
      label: "FPS floor",
      min: 0,
