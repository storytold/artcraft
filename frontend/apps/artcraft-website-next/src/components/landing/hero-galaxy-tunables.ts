...
export const galaxyMotionTuner = defineTunables(
  ...
  "Galaxy motion",
  {
    ...
    introDur: {
      ...
      step: 0.05,
      default: 1.4,
      info: "Duration of the intro stream: the whole conveyor pours out of the center as one eased train and settles into live drift together. Starts at the master Intro group's Cards beat.",
    },
    perfFloor: {
      label: "FPS floor",
      min: 0,
