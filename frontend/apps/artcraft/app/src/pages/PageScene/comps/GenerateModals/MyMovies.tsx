...
import { CompletedCard } from "~/pages/PageScene/comps/GenerateModals/CompletedCard";
import { InProgressCard } from "~/pages/PageScene/comps/GenerateModals/InProgressCard";
...
export function MyMovies({ setMovieId }: Props) {
  useSignals();
  const viewMyMovies = usePageSceneStore((s) => s.viewMyMovies);
  const setViewMyMovies = usePageSceneStore((s) => s.setViewMyMovies);
